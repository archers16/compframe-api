...

{
  ...
  "global_warnings": "Array of PLAIN STRINGS (not objects). Each warning is 1-2 sentences. Write for a VP Sales audience, not comp specialists. Avoid jargon. Be specific and actionable.",
  "assumptions": "Array of PLAIN STRINGS (not objects). Each assumption is a single clear sentence a CEO could understand. Do NOT return objects with id/statement fields. Example: ['Quota attainment distribution follows a normal curve centered at 85%.']"
}
...
WARNINGS AND ASSUMPTIONS FORMAT:
- global_warnings MUST be an array of strings: ["warning text", "warning text"]
- assumptions MUST be an array of strings: ["assumption text", "assumption text"]
- Do NOT use objects like {"id": "...", "statement": "..."}
- Keep language simple enough for a non-comp executive to understand
- Each warning or assumption should be 1-2 sentences maximum
...

{
  ...
  "slide_content": {
    ...
    "exec_summary_bullets": ["3-4 headline findings. 1-2 sentences max each."],
    ...
    "role_detail_slides": [
      {
        ...
        "bullets": ["4-6 bullets covering OTE, mix, measures, accelerators, ramp, key rationale. Use EXACT numbers."],
